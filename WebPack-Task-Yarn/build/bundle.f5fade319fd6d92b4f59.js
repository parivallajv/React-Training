/*! For license information please see bundle.f5fade319fd6d92b4f59.js.LICENSE.txt */
(() => {
  var e = {
      144: (e, t, n) => {
        "use strict";
      ...
      448: (e, t, n) => {
        ...
        function Be(e, t, n, r, a, l, o, i, u) {
          (Ae = !1), (Me = null), De.apply(je, arguments);
        }
        function Ve(e) {
          var t = e,
            n = e;
              ...
              (function (e, t, n, r, a) {
                switch (t) {
                  ...
                  case "gotpointercapture":
                    return (
                      (l = a.pointerId),
                      zt.set(l, At(zt.get(l) || null, e, t, n, r, a)),
                      !0
                    );
                }
                return !1;
        ...
        function Va() {
          if (!ja && null !== Ua) {
            ...
            try {
              ...
              throw (null !== Ua && (Ua = Ua.slice(e + 1)), qe(Ze, Va), t);
            } finally {
              (bt = t), (ja = !1);
            }
          }
        ...
        var Bl = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (l.payload = t),
              null != n && (l.callback = n),
              null !== (t = Fl(e, l, a)) && (rs(t, e, a, r), Dl(t, e, a));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (a.tag = 2),
              null != t && (a.callback = t),
              null !== (t = Fl(e, a, r)) && (rs(t, e, r, n), Dl(t, e, r));
          },
        };
          ...
          return (
            "object" == typeof l && null !== l
              ...
              : ((a = za(t) ? Oa : Pa.current),
                (l = (r = null != (r = t.contextTypes)) ? Ra(e, a) : Na)),
            (t = new t(n, l)),
            (e.memoizedState =
        ...
        function Wl(e, t, n, r) {
          var a = e.stateNode;
          (a.props = n), (a.state = e.memoizedState), (a.refs = Il), Rl(e);
          var l = t.contextType;
          "object" == typeof l && null !== l
            ? (a.context = Cl(l))
            : ((l = za(t) ? Oa : Pa.current), (a.context = Ra(e, l))),
          ...
          if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
            return (function (e, t, n, r, a, o, i) {
              ...
              if (((u = 0 != (i & e.childLanes)), wi || u)) {
                ...
                return gs(), ji(e, t, i, (r = fi(Error(l(421)))));
              }
              return "$?" === a.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
        ...
        function _s(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Ou === e &&
              (zu & n) === n &&
              (4 === Du ||
              (3 === Du && (130023424 & zu) === zu && 500 > Ye() - Vu)
                ? ps(e, 0)
                : (Iu |= n)),
            as(e, t);
        }
        ...
        function $s(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = Fl(a, t, o)) && (rs(e, a, o, l), Dl(e, a, o)),
            o
          );
        }
        function Ws(e) {
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      var b;
      const w = (e) => ((e = e.toLowerCase()), (t) => v(t) === e),
        k = (e) => (t) => typeof t === e,
        { isArray: S } = Array,
        E = k("undefined"),
        x = w("ArrayBuffer"),
      ...
      const M =
        ...
        U = (e) => !E(e) && e !== M,
        I =
          ((j = "undefined" != typeof Uint8Array && y(Uint8Array)),
          (e) => j && e instanceof j);
      var j;
      const B = w("HTMLFormElement"),
        V = (
          ({ hasOwnProperty: e }) =>
          (t, n) =>
            e.call(t, n)
        ...
        J = {
          ...
          freezeMethods: (e) => {
            $(e, (t, n) => {
              if (_(e) && -1 !== ["arguments", "caller", "callee"].indexOf(n))
                return !1;
              const r = e[n];
              _(r) &&
                ((t.enumerable = !1),
          ...
          isAsyncFn: K,
          isThenable: (e) => e && (P(e) || _(e)) && _(e.then) && _(e.catch),
        };
      ...
      [
        ...
        Object.defineProperties(X, G),
        Object.defineProperty(Y, "isAxiosError", { value: !0 }),
        (X.from = (e, t, n, r, a, l) => {
          const o = Object.create(Y);
          return (
            J.toFlatObject(
              e,
              o,
      ...
      const re = J.toFlatObject(J, {}, null, function (e) {
                ...
                return (
                  ...
                  i.forEach(function (e, r) {
                    !J.isUndefined(e) &&
                      null !== e &&
                      t.append(
                        !0 === o ? ne([n], r, l) : null === o ? n : n + "[]",
                        u(e),
                      );
                  }),
                  !1
                );
            return !!ee(e) || (t.append(ne(a, n, l), u(e)), !1);
          }
          const c = [],
            f = Object.assign(re, {
              defaultVisitor: s,
          ...
          return (
            (function e(n, r) {
              if (!J.isUndefined(n)) {
                ...
                c.push(n),
                  J.forEach(n, function (n, l) {
                    !0 ===
                      (!(J.isUndefined(n) || null === n) &&
                        a.call(t, n, J.isString(l) ? l.trim() : l, r, f)) &&
                      e(n, r ? r.concat(l) : [l]);
                  }),
                  c.pop();
              }
        ...
        he = function (e) {
          function t(e, n, r, a) {
            ...
            return (
              ...
              i
                ? (J.hasOwnProp(r, l) ? (r[l] = [r[l], n]) : (r[l] = n), !o)
          ...
          transformRequest: [
            function (e, t) {
              ...
              if (
                ...
                return r && r ? JSON.stringify(he(e)) : e;
              if (
                J.isArrayBuffer(e) ||
                J.isBuffer(e) ||
                J.isStream(e) ||
      ...
      J.inherits(Ne, Z, { __CANCEL__: !0 });
      const Pe = Ne,
        Te = pe.isStandardBrowserEnv
          ? {
      ...
      const Re = pe.isStandardBrowserEnv
        ? (function () {
          ...
          function (e) {
            return new Promise(function (t, n) {
              ...
              if (
                ...
                (u.onabort = function () {
                  u &&
                    (n(new Z("Request aborted", Z.ECONNABORTED, e, u)),
                    (u = null));
                }),
                (u.onerror = function () {
        ...
        return (
          ...
          ((e) => {
            ...
            for (
              let a = 0;
              a < t &&
              ((n = e[a]), !(r = J.isString(n) ? Le[n.toLowerCase()] : n));
              a++
            );
            if (!r) {
              if (!1 === r)
          ...
          assertOptions: function (e, t, n) {
            ...
            for (; a-- > 0; ) {
              ...
              if (o) {
                ...
                throw new Z("Unknown option " + l, Z.ERR_BAD_OPTION);
            }
          },
          validators: Ue,
        },
      ...
      class Ve {
        ...
        request(e, t) {
          ...
          void 0 !== n &&
            ...
            (l = a && J.merge(a.common, a[t.method])),
            l &&
              J.forEach(
        ...
        getUri(e) {
          return ce(
            Oe((e = Me(this.defaults, e)).baseURL, e.url),
            e.params,
            e.paramsSerializer,
          );
        }
      ...
      const qe = Qe,
        Ke = (function e(t) {
          const n = new He(t),
            r = m(He.prototype.request, n);
          return (
            J.extend(r, He.prototype, n, { allOwnKeys: !0 }),
      ...
      (Ke.Axios = He),
        ...
        (Ke.mergeConfig = Me),
        (Ke.AxiosHeaders = xe),
        (Ke.formToJSON = (e) => he(J.isHTMLForm(e) ? new FormData(e) : e)),
        (Ke.HttpStatusCode = qe),
        (Ke.default = Ke);
      const Je = Ke,
        Xe = function () {
          Je.get("https://icanhazdadjoke.com", {
      ...
      var Ye = n(294);
      n(745), n(518);
      const Ge = n.p + "20adfb35ae6a6e5817bf08950d874196.png",
        Ze = function () {
          return Ye.createElement(
            "div",
            { class: "container" },
            Ye.createElement("img", { src: Ge, alt: "gggjhg" }),
            Ye.createElement("h3", null, "Don't Laught Challenge"),
            Ye.createElement("div", { id: "joke", class: "joke" }),
            Ye.createElement(
              "button",
              { id: "jokeBtn", class: "btn", onClick: Xe },
              "Get Another Joke",
            ),
          );
        };
